...
def prepare_data(batch_size):
    ...
    return dataset_train, train_batches_per_epoch


def learn(batch_size=32,
          learning_rate=1e-3,
          num_classes=10,
          num_channels=8,
          epochs_per_module=1,
    ...
    dataset_train, train_batches_per_epoch = prepare_data(batch_size)
        ...
        for epoch in range(epochs_per_module):
            ...
            for batch in tqdm(dataset_train, total=train_batches_per_epoch):
                ...
                with tf.contrib.summary.always_record_summaries():
                    ...
                    [
                        tf.contrib.summary.scalar(
                            "mean_boosted_classifier_accuracy_module_{}".
                            format(i),
                            a,
                            family='accuracy')
                    ...
                    [
                        tf.contrib.summary.scalar(
                            "gamma_{}-{}".format(i, i + 1), a, family='gamma')
...
if __name__ == "__main__":
    ...
    learn(epochs_per_module=args.epochs_per_module)
